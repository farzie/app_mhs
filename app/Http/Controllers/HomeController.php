...
class HomeController extends Controller
{
    public function index()
    {
        ...
        // 3. Ambil data status lainnya yang mungkin ada (misal: "Drop Out", "Non Aktif")
        // Ini lebih baik menggunakan Group By jika Anda ingin semua status
        ...
        // Siapkan data yang pasti untuk dikirim ke View
        $data = [
            ...
            'status_distribusi' => $status_distribusi, // Data detail distribusi status
        ];
