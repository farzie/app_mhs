...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-4xl mx-auto mt-12">
        <div class="bg-white shadow-2xl rounded-xl p-8 md:p-12 border-t-4 border-indigo-600">
            ...
            <div class="space-y-6">
                {{-- MENGGUNAKAN $user SECARA KONSISTEN --}}
            ...
            {{-- PERBAIKAN: Menambahkan div flex untuk mengatur tombol --}}
            <div class="mt-10 flex justify-between items-center border-t pt-6">
                
                {{-- TOMBOL LOGOUT (JUSTIFY LEFT) --}}
                ...
                <a href="{{ route('home') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-3 px-8 rounded-lg shadow-md transition duration-200 flex items-center">
