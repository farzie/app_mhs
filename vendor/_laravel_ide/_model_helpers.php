...
namespace App\Models {
    ...
    /**
     * App\Models\mahasiswas
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string $nama
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<mahasiswas>|mahasiswas whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<mahasiswas>|mahasiswas whereNama($value)
     * @method static \Illuminate\Database\Eloquent\Builder<mahasiswas>|mahasiswas whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<mahasiswas>|mahasiswas whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<mahasiswas>|mahasiswas newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<mahasiswas>|mahasiswas newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<mahasiswas>|mahasiswas query()
     ...
     */
    class mahasiswas extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
